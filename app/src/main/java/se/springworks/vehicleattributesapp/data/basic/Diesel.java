...
public class Diesel {
     ...
     */
    public Diesel(AverageConsumption averageConsumption) {
        super();
     ...
     * @param tankVolume
     */
    public Diesel(AverageConsumption averageConsumption, Double tankVolume) {
        super();
        this.averageConsumption = averageConsumption;
     ...
     * @param tankVolume
     */
    public Diesel(Double tankVolume) {
        super();
        this.averageConsumption = averageConsumption;
    }
